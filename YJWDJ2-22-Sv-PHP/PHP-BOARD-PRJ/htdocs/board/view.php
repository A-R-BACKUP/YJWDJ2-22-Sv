        ...
        <div id="main" class="container-fluid h-100 px-0">
            ...
            <div class="px-5">
                ...
                <nav class="blog-pagination" aria-label="Pagination">
                    <a class="btn btn-outline-primary" href="<?=$_board_options['listPage']?>?q=<?=$q?>">목록</a>
                    <a class="btn btn-outline-secondary" href="<?=$_board_options['modifyPage']?>?idx=<?=$idx?>&q=<?=$q?>">수정</a>
